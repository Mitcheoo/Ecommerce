...
namespace Ecommerce.Controllers
{
    ...
    {
        private readonly DatabaseEcommerceContext _context;

        public HangHoasController(DatabaseEcommerceContext context)
        {
            _context = context;
        }
        ...
        {
            var databaseEcommerceContext = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await databaseEcommerceContext.ToListAsync());
        }
